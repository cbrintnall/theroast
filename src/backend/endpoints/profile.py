...
from sqlalchemy import Table, Column, String, Integer, exists, ForeignKey
...
class Profile(application.application.Model):
    __tablename__ = "profiles"
    id = Column(Integer, primary_key=True)
    name = Column(String(120), unique=True, nullable=False)

    parent_id = Column(Integer, ForeignKey("beans.id"))
